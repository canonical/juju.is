...
def serve_assets(text):
    ...
    Purpose:
    This is partially a workaround for the fact that the google chrome flags the S3 bucket URL as a lookalike for charmhub.io and prompts the user to visit the latter.
